...
# Define room dimensions and microphone array position
room_sz = [5, 6, 3]  # Room dimensions [m]

# Function to generate spherical microphone array
...
# Ensure the microphone array center is at the room's center, avoiding the array exceeding room bounds
...
pos_traj[:, 0] = np.linspace(0.5, 4.5, traj_pts)  # Move the source along the x-axis, ensuring it stays in the room
...
# Generate Room Impulse Response (RIR) at each trajectory point
